...
public class SportTypeVideoLeftFragment extends BaseFragment {
    ...
    protected void init(View rootView) {
        ...
        String sportPicUrl = getArguments().getString("sportPicUrl");
        Log.i("yys","sportPicUrl=="+sportPicUrl);
        ImgViewUtils.loadImage(getPageContext(),R.drawable.shape_grey_5,getArguments().getString("sportPicUrl"),imgBg);
//        imgBg.setImageResource(R.drawable.sport_bg_skipping);
        tvSportDesc.setText(getArguments().getString("sportContent"));
