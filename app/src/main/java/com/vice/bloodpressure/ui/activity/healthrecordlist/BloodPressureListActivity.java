    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_begin_time:
                PickerUtils.showTimeWindow(BloodPressureListActivity.this, new boolean[]{true, true, true, false, false, false}, DataFormatManager.TIME_FORMAT_Y_M_D, new PickerUtils.TimePickerCallBack() {
                    @Override
