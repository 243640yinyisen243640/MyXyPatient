 ...
 * 描述:
 */
public class InsulinDeviceListAdapter extends BaseAdapter {
    private Context context;
    private List<DrugInfo> list;

    public InsulinDeviceListAdapter(Context context, List<DrugInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        //        if (convertView == null) {
        convertView = LayoutInflater.from(context).inflate(R.layout.item_insulin_device_list, parent, false);
        TextView textView = convertView.findViewById(R.id.tv_insulin_device_list_num);
