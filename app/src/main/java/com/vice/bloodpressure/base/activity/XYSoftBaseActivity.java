...
public class XYSoftBaseActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    /**
     * 请求码-权限请求
     */
    ...
    private class HHSoftBaseHandler extends Handler {
        private WeakReference<XYSoftBaseActivity> activityWeakReference;

        public HHSoftBaseHandler(XYSoftBaseActivity activityWeakReference) {
        ...
        public void handleMessage(Message msg) {
            ...
            XYSoftBaseActivity activity = activityWeakReference.get();
            if (activity != null) {
